 ...
 * @Configuration
 * 
 * @MapperScan(basePackages = "com.sam.ats.dao") public class DataAccessConfig {
 * 
 ...
 * 
 * sessionFactory.setDataSource(dataSource); sessionFactory.setMapperLocations(
 * new PathMatchingResourcePatternResolver().getResources(
 * "classpath:mybatis/mapper/*.xml") ); return sessionFactory.getObject(); }
 * 
